...
impl App {
    const VERSION_URL: &'static str = "https://raw.githubusercontent.com/edwardburgos/mobile-cicd/main/.version";
    ...
    fn download_repo(&self) -> Result<()> {
        ...
        let (code, _, _) = sh!("git clone --branch {version} --depth 1 https://github.com/edwardburgos/mobile-cicd {repo_dir}");
        if code != 0 {
